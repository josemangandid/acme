...
class EditarEncuestaController extends GetxController {
  ...
  @override
  void onInit() {
    encuesta = Get.arguments as Encuesta;
    _campos.value = encuesta!.campos!;
    _name.text = encuesta!.name!;
    _description.text = encuesta!.discription!;
    super.onInit();
  }
  ...
  editarEncuesta(BuildContext context) {
    if (_formKeyEncuesta.currentState!.validate() && campos.isNotEmpty) {
      ...
      controller.editarEncuesta(encuestaa);
